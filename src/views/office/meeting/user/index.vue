...
export default {
  ...
  created() {
    const meetingId = this.$route.params && this.$route.params.meetingId;
    ...
    submitForm() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          ...
          // } else
          {
            this.sysMeetingUsers.push(this.form)
            this.sysMeetingUsers.push(this.form)
            addUser(this.sysMeetingUsers).then(response => {
